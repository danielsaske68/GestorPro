...
RAILWAY_WEBHOOK = "https://monitor-homeserve-production.up.railway.app/telegram_webhook"

LOCAL_WEBHOOK = "https://nonglacial-mammillary-teena.ngrok-free.dev/telegram_webhook"
...
def volver_a_railway():

    logger.info("Volviendo a Railway...")
    ...
    while True:
        ...
        try:
            ...
            if r.status_code != 200:
                ...
                if not railway_caido:

                    logger.warning(
                        "Railway caído. Cambiando a PC..."
                    )
            ...
            if not railway_caido:
                ...
                logger.warning(
                    "Railway no responde. Pasando a local"
                )
...
def iniciar_servidor():
    ...
    logger.info("Iniciando Flask local...")
